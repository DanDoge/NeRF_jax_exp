...
class NerfModel(nn.Module):
  ...
  def apply(self, rng_0, rng_1, origins, directions, viewdirs,
    ...
    if num_fine_samples > 0:
      ...
      sigma_coarse = jnp.where(((z_vals_coarse > mu[Ellipsis, None] - 0.01) & (z_vals_coarse < mu[Ellipsis, None] + 0.01))[Ellipsis, None], 0., sigma_coarse)
      '''
      ...
      ret.append((comp_rgb, disp, unused_weights))
    return ret
